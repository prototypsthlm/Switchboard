...
function ResultFormatter(result, config) {    
    ...
    */
    var findArrayPath = function(obj, path, index) {
        console.log("findArrayPath(obj,",path,",",index,")");
            ...
            if(nextConnectorResults) {
                ...
                //for(var j = 0; j < results.length; j++) { 
                    ...
                    if(nextConnectorResult) {
                        ...
                        logger.warn("No result found in connector",connectorIndex+1," at index", j,"using callindex",connectorCall.meta.index,". Remove! (extract merge)!");
