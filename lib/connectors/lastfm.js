...
Lastfm.prototype.getActionUrl = function(query, apiConfig){
    ...
    if(apiConfig.in_param_name == "mbid")
        parameterObject[apiConfig.in_param_name] = query.replace("musicbrainz:artist:", ""); //clean out nasty echonest formatting, should be done in echonest connectorResult?
