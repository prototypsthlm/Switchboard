...
var apiActions = {
    "albumSearch" : { action: ['album','search'], in_param_names: ['album'], output_nodes: ['albummatches.album.name','albummatches.album.artist','albummatches.album.id','albummatches.album.mbid'], optionals: ['limit','page'] },
    ...
    "trackSearch" : { action: ['track','search'], in_param_names: ['tag'], output_nodes: ['results.trackmatches.track.name', 'results.trackmatches.track.mbid', 'results.trackmatches.track.listeners', 'results.trackmatches.track.artist.name'], optionals: ['page','limit','artist'] },
